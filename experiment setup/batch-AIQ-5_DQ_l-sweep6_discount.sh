...
agents=(
	DQ_l,0.0003,0.995,32,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.95,32,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.9,32,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.8,32,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.7,32,0.01,2000,64,512,0,1,2,0.000,0
)
...
# Batch AIQ log file
batch_log=batch-AIQ-5_DQ_l_sweep6-discount.log
