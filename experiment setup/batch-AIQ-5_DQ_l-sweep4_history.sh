...
agents=(
	DQ_l,0.0003,0.99,32,0.01,2000,64,512,0,1,0,0.000,0
	DQ_l,0.0003,0.99,32,0.01,2000,64,512,0,1,1,0.000,0
	DQ_l,0.0003,0.99,32,0.01,2000,64,512,0,1,3,0.000,0
	DQ_l,0.0003,0.99,32,0.01,2000,64,512,0,1,4,0.000,0
	DQ_l,0.0003,0.99,32,0.01,2000,64,512,0,1,5,0.000,0
)
...
# Batch AIQ log file
batch_log=batch-AIQ-5_DQ_l_sweep4-history.log
