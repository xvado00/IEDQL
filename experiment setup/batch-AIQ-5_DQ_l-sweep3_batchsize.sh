...
agents=(
	DQ_l,0.0003,0.99,64,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.99,16,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.99,8,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.99,4,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.99,2,0.01,2000,64,512,0,1,2,0.000,0
	DQ_l,0.0003,0.99,1,0.01,2000,64,512,0,1,2,0.000,0
)
...
# Batch AIQ log file
batch_log=batch-AIQ-5_DQ_l_sweep3-batchsize.log
